...
class EditLocalActionWidget extends StatefulWidget {
  ...
  @override
  State<EditLocalActionWidget> createState() => _EditLocalActionWidgetState();
}

class _EditLocalActionWidgetState extends State<EditLocalActionWidget> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<EditLocalActionCubit>(),
      child: Form(
        key: _formKey,
        child: Column(
          children: [
            BlocConsumer<EditLocalActionCubit, EditLocalActionState>(
              listener: (context, state) {
                switch (state) {
                  case EditLocalActionInitial():
                  case EditLocalActionLoading():
                    break;
                  case EditLocalActionSuccess():
                    context.pop(state.action);
                    break;
                  case EditLocalActionError():
                    context.showErrorDialog(
                        title: 'Failed to save action',
                        message: 'Something went wrong, please try again later',
                        onRetry: () {
                          context.read<EditLocalActionCubit>().editAction(
